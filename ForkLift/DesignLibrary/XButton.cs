...
namespace DesignLibrary
{
    public partial class XButton : Button
    {
        ...
        private DesignLibrary.Theme thm = DesignLibrary.Theme.MSOffice2010_BLUE;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (thm == DesignLibrary.Theme.MSOffice2010_BLUE || thm == DesignLibrary.Theme.MSOffice2010_Green || thm == DesignLibrary.Theme.MSOffice2010_Yellow || thm == DesignLibrary.Theme.MSOffice2010_Publisher ||
                thm == DesignLibrary.Theme.MSOffice2010_RED || thm == DesignLibrary.Theme.MSOffice2010_WHITE || thm == DesignLibrary.Theme.MSOffice2010_Pink)
            {
        ...
        public DesignLibrary.Theme Theme
        {
            get
            {
                if (this.colorTable == Colortable.Office2010Green)
                {
                    return DesignLibrary.Theme.MSOffice2010_Green;
                }
                else if (this.colorTable == Colortable.Office2010Red)
                {
                    return DesignLibrary.Theme.MSOffice2010_RED;
                }
                else if (this.colorTable == Colortable.Office2010Pink)
                {
                    return DesignLibrary.Theme.MSOffice2010_Pink;
                }
                else if (this.colorTable == Colortable.Office2010Yellow)
                {
                    return DesignLibrary.Theme.MSOffice2010_Yellow;
                }
                else if (this.colorTable == Colortable.Office2010White)
                {
                    return DesignLibrary.Theme.MSOffice2010_WHITE;
                }
                else if (this.colorTable == Colortable.Office2010Publisher)
                {
                    return DesignLibrary.Theme.MSOffice2010_Publisher;
                }

                return DesignLibrary.Theme.MSOffice2010_BLUE;
            }
            ...
            set
            {
                ...
                if (thm == DesignLibrary.Theme.MSOffice2010_Green)
                {
                    this.colorTable = Colortable.Office2010Green;
                }
                else if (thm == DesignLibrary.Theme.MSOffice2010_RED)
                {
                    this.colorTable = Colortable.Office2010Red;
                }
                else if (thm == DesignLibrary.Theme.MSOffice2010_Pink)
                {
                    this.colorTable = Colortable.Office2010Pink;
                }
                else if (thm == DesignLibrary.Theme.MSOffice2010_WHITE)
                {
                    this.colorTable = Colortable.Office2010White;
                }
                else if (thm == DesignLibrary.Theme.MSOffice2010_Yellow)
                {
                    this.colorTable = Colortable.Office2010Yellow;
                }
                else if (thm == DesignLibrary.Theme.MSOffice2010_Publisher)
                {
